...
यह केवल पेमेंट से अधिक है: यह परमिशन मैनेजमेंट, मीटरिंग, cron jobs के साथ उपयोग सीमाएं बनाना, और इसे अपग्रेड, डाउनग्रेड, कैंसिलेशन और फेल पेमेंट स्टेट्स से कनेक्ट करना है। रेस कंडीशन, एज केस और अन्य बग आपको धीमा कर देंगे।

**2️⃣ बिलिंग और ऐप लॉजिक को अलग होना चाहिए**

बढ़ती कंपनियां अक्सर प्राइसिंग पर इटरेट करती हैं: कीमतें बढ़ाना, क्रेडिट के साथ प्रयोग करना या किसी नई फीचर के लिए चार्ज करना। DB माइग्रेशन, इन-ऐप फ्लो को फिर से बनाना, कस्टम प्राइसिंग के लिए इंटर्नल डैशबोर्ड और पुरानी प्राइसिंग पर यूजर्स को ग्रैंडफादर करना एक दुःस्वप्न है।
